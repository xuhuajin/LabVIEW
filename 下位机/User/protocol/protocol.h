...
#define SEND_P_I_D_CMD       0x03     // 发送位置控制 PID 值（同步上位机显示的值）
...
#define SEND_MODE_CMD		 0x07     // 发送PID控制模式（同步上位机显示的值）
#define SEND_S_P_I_D_CMD     0x08     // 发送速度控制 PID 值（同步上位机显示的值）
...
#define SET_MODE_CMD		 0x16	  // 设置PID控制模式
